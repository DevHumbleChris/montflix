...
const TRENDING_TODAY =
  "https://api.themoviedb.org/3/trending/all/day?api_key=b9326276faf774560703e2e9152fa7e7";

const MOVIE_DETAIL_URL = "https://api.themoviedb.org/3/movie/";
const MOVIE_DETAIL_REST_URL =
  "?api_key=b9326276faf774560703e2e9152fa7e7&language=en-US";
const TV_DETAILS_URL = "https://api.themoviedb.org/3/tv/";
const TV_DETAILS_REST_URL =
  "?api_key=b9326276faf774560703e2e9152fa7e7&language=en-US";
  ...
  try {
    async function getDetailMovieImage() {
      ...
      response = await fetch(
        `${MOVIE_DETAIL_URL}${id}${MOVIE_DETAIL_REST_URL}`
      );
      responseData = response.json();
